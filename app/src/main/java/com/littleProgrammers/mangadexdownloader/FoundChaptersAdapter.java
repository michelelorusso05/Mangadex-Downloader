...
public class FoundChaptersAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context ct;
    ...
    private final int PIXELS_TO_DP;
    ...
    public FoundChaptersAdapter(Context _ct, ArrayList<Chapter> _chapters,
        ...
        PIXELS_TO_DP = (int) TypedValue.applyDimension(
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (mappedChapter == -1) {
            ...
            else if (volume.equals("Oneshot"))
                labelViewHolder.volume.setText(volume);
            else
