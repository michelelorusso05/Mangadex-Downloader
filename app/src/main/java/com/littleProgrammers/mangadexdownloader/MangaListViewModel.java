...
public class MangaListViewModel extends ViewModel {
    ...
    public void updateMangaList(Manga[] mangas, int state) {
        uiState.setValue(new MangaListState(mangas, null, state));
    }
    public void updateMangaList(Manga[] mangas, HashMap<Integer, String> sectionMap, int state) {
        uiState.setValue(new MangaListState(mangas, sectionMap, state));
    }

    public static class MangaListState {
        public MangaListState(Manga[] m, HashMap<Integer, String> s, int alreadySearched) {
            mangas = m;
            sectionMap = s;
